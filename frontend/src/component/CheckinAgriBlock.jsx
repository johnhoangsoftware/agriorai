...
const CheckIAgriblock = () => {
    return (
        <>
            <body class="home-sticky-pin sidebar-header scrollspy-example position-relative" data-bs-spy="scroll"
                        ...
                        <div class="sidebar-nav-wrapper">
                            <nav class="mainmenu-nav">
                                <ul class="mainmenu list-group">
                                    <li class="nav-item"><a class="nav-link" href="index.html"> <i data-feather="home"></i>Home</a>
                                    </li>
                                    <li class="nav-item"><a class="nav-link" href="marketplace.html"> <i
                                        data-feather="heart"></i>MarketPlace</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#"> <i
                                        data-feather="trending-up"></i>Check-in</a></li>
                                    <li class="nav-item"><a class="nav-link" href="#"> <i data-feather="trending-up"></i>Vote
                                        Star</a></li>
                                </ul>
                            </nav>
                        </div>
                    ...
                    <div class="inner">
                        ...
                        <nav>
                            <ul class="mainmenu" id="navbar-example2">
                                ...
                                <li class="nav-item"><a class="nav-link" href="#"> <i data-feather="trending-up"></i>Vote Star</a>
                                </li>
                            </ul>
                        </nav>
                    </div>
                ...
                <div class="rn-nft-mid-wrapper">
                    ...
                    <div id="list-item-1">
                        ...
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d21067.322846408115!2d105.84318760425181!3d21.024213269344873!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135ac69f861af3f%3A0x331250d72cd2fa28!2zSOG7kyBHxrDGoW0gKEhvYcyAbiBLacOqzIFtKQ!5e0!3m2!1svi!2s!4v1679921604712!5m2!1svi!2s"
                            width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy"
                            referrerpolicy="no-referrer-when-downgrade"></iframe>
                        <div class="rn-top-top-seller-area nice-selector-transparent pt--50">
                            <div class="container">
                                <div class="row  mb--30">
                                    <div class="col-12 justify-sm-center d-flex">
                                        <h3 class="title sal-animate" data-sal-delay="150" data-sal="slide-up"
                                            data-sal-duration="800">Top Seller in</h3>
                                        ...
                                        <div class="nice-select" tabindex="0"><span class="current">1 day</span>
                                            <ul class="list">
                                                <li data-value="1 day" data-display="1 day" class="option selected"> 1 day</li>
                                                <li data-value="1" class="option">7 Day's</li>
                                                <li data-value="2" class="option">15 Day's</li>
                                                <li data-value="4" class="option">30 Day's</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>

                                <div class="col-12 justify-sm-center g-5 top-seller-list-wrapper">
                                    <div class="top-seller-wrapper">
                                        <table style=" border-radius: 20px;" class="table">
                                            <thead>
                                                <tr>
                                                    <th scope="col">
                                                        <h1>1</h1>
                                                    ...
                                                    <th style="width: 65px;" scope="col">
                                                        <div style="width: 60px;" class="thumbnail varified">
                                                            <a href="author.html"><img style=" width: 60px; margin-bottom: 20px;"
                                                                src="assets/images/client/client-12.png" alt="Nft_Profile"
                                                                class="rounded-circle" /></a>
                                                        </div>
                                                    </th>
                                                    <th scope="col">
                                                        <div class="top-seller-content">
                                                            <a style="text-decoration: none; position: relative; bottom: 15px;"
                                                                href="author.html">
                                                                <h6 style="margin-bottom: 20px;" id="Bean_Farm" class="name">Bean
                                                                    Farm</h6>
                                                            </a>
                                                        </div>
                                                    </th>
                                                    <th scope="col">
                                                        <div>
                                                            <h5 style="position: relative; bottom: 15px;"
                                                                class="count-number fw-bold text-warning">
                                                                $2500,000
                                                            </h5>
                                                        </div>
                                                    </th>
                        ...
                        <div class="container">
                            ...
                            <div class="row g-5">
                                <div data-sal="slide-up" data-sal-delay="150" data-sal-duration="800"
                                    class="col-lg-6 col-xl-3 col-md-6 col-sm-6 col-12">
                    ...
                    <div id="list-item-3" class="rn-product-area rn-section-gapBottom masonary-wrapper-activation">
                        <div class="container">
                            <div class="row gx-5 align-items-center">
                                ...
                                <div class="col-lg-8">
                                    <div
                                        ...
                                        <button data-filter=".cat--1"><span class="filter-text">Vegetable</span></button>
                                        <button data-filter=".cat--2"><span class="filter-text">Fruit</span></button>
                                        <button data-filter=".cat--3"><span class="filter-text">Meet</span></button>
                                        <button data-filter=".cat--4"><span class="filter-text">Rice</span></button>
                                    </div>
                                </div>
                            </div>
                            <div class="row g-5">
                                    ...
                                    <div class="grid-metro4 mesonry-list">
                                            ...
                                            <div class="product-style-one no-overlay">
                                                <div class="card-thumbnail">
                                                    <a href="product-details.html"><img
                                                        src="/assets/images/protfolio/portfolio-01.jpg" alt="NFT_portfolio" /></a>
                                                </div>
                                                <div class="product-share-wrapper">
                                                    <div class="profile-share">
                                                        <a href="author.html" class="avatar" data-tooltip="Mark Jonee"><img
                                                            src="assets/images/client/client-6.png" alt="Nft_Profile" /></a>
                                                        <a href="author.html" class="avatar" data-tooltip="Jone"><img
                                                            src="assets/images/client/client-10.png" alt="Nft_Profile" /></a>
                                                        <a href="author.html" class="avatar" data-tooltip="MArk"><img
                                                            src="assets/images/client/client-9.png" alt="Nft_Profile" /></a>
                                                ...
                                                <a href="product-details.html"><span class="product-name">Beef</span></a>
                                                <span class="latest-bid">Highest bid 1/20</span>
                                                <div class="bid-react-area">
                                                    <div class="last-bid">20$</div>
                                        ...
                                        <div class="grid-metro-item cat-3 cat--4">
                                            <div class="product-style-one no-overlay">
                                                <div class="card-thumbnail">
                                                    <a href="product-details.html"><img
                                                        src="/assets/images/protfolio/portfolio-02.jpg" alt="NFT_portfolio" /></a>
                                                </div>
                                                <div class="product-share-wrapper">
                                                    <div class="profile-share">
                                                        <a href="author.html" class="avatar" data-tooltip="Jone BIden"><img
                                                            src="assets/images/client/client-1.png" alt="Nft_Profile" /></a>
                                                        <a href="author.html" class="avatar" data-tooltip="BIden"><img
                                                            src="assets/images/client/client-9.png" alt="Nft_Profile" /></a>
                                                        <a href="author.html" class="avatar" data-tooltip="Jone"><img
                                                ...
                                                <a href="product-details.html"><span class="product-name">Banana</span></a>
                                                <span class="latest-bid">Highest bid 5/11</span>
                                                <div class="bid-react-area">
                                                    <div class="last-bid">3.5$</div>
                                                    <div class="react-area">
                                                        <svg viewBox="0 0 17 16" fill="none" width="16" height="16"
                                                            class="sc-bdnxRM sc-hKFxyN kBvkOu">
                                                            <path
                                        ...
                                        <div class="grid-metro-item cat-2">
                                            <div class="product-style-one no-overlay">
                                                <div class="card-thumbnail">
                                                    <a href="product-details.html"><img
                                                        src="/assets/images/protfolio/portfolio-03.jpg" alt="NFT_portfolio" /></a>
                                                </div>
                                                <div class="product-share-wrapper">
                                                    <div class="profile-share">
                                                        <a href="author.html" class="avatar" data-tooltip="Twest Master"><img
                                                            src="assets/images/client/client-9.png" alt="Nft_Profile" /></a>
                                                        <a href="author.html" class="avatar" data-tooltip="Twest"><img
                                                            src="assets/images/client/client-9.png" alt="Nft_Profile" /></a>
                                                        <a href="author.html" class="avatar" data-tooltip="Master"><img
                                                            src="assets/images/client/client-9.png" alt="Nft_Profile" /></a>
                                                        <a class="more-author-text" href="#">48+ Place Bit.</a>
                                                    </div>
                                                    <div class="share-btn share-btn-activation dropdown">
                                                        <button class="icon" type="button" data-bs-toggle="dropdown"
                                                            aria-expanded="false">
                                                ...
                                                <a href="product-details.html"><span class="product-name">Rice Soc Trang</span></a>
                                                <span class="latest-bid">Highest bid 2/31</span>
                                                <div class="bid-react-area">
                                                    <div class="last-bid">25$</div>
                                                    <div class="react-area">
                                                        <svg viewBox="0 0 17 16" fill="none" width="16" height="16"
                                                            class="sc-bdnxRM sc-hKFxyN kBvkOu">
                                                            <path
                                        ...
                                        <div class="grid-metro-item cat--1 cat--2">
                                            <div class="product-style-one no-overlay">
                                                <div class="card-thumbnail">
                                                    <a href="product-details.html"><img
                                                        src="/assets/images/protfolio/portfolio-04.jpg" alt="NFT_portfolio" /></a>
                                                </div>
                                                <div class="product-share-wrapper">
                                                    <div class="profile-share">
                                                        <a href="author.html" class="avatar" data-tooltip="Barua Time"><img
                                                            src="assets/images/client/client-2.png" alt="Nft_Profile" /></a>
                                                        <a href="author.html" class="avatar" data-tooltip="Barua Mir"><img
                                                            src="assets/images/client/client-9.png" alt="Nft_Profile" /></a>
                                                        <a href="author.html" class="avatar" data-tooltip="Barua Sobuj"><img
                                                            src="assets/images/client/client-10.png" alt="Nft_Profile" /></a>
                                                        <a class="more-author-text" href="#">26+ Place Bit.</a>
                                                    </div>
                                                    <div class="share-btn share-btn-activation dropdown">
                                                        <button class="icon" type="button" data-bs-toggle="dropdown"
                                                            aria-expanded="false">
                                                ...
                                                <a href="product-details.html"><span class="product-name">Apple America</span></a>
                                                <span class="latest-bid">Highest bid 3/16</span>
                                                <div class="bid-react-area">
                                                    <div class="last-bid">10$</div>
                                                    <div class="react-area">
                                                        <svg viewBox="0 0 17 16" fill="none" width="16" height="16"
                                                            class="sc-bdnxRM sc-hKFxyN kBvkOu">
                                                            <path
                                        ...
                                        <div class="grid-metro-item cat--1 cat--2">
                                            <div class="product-style-one no-overlay">
                                                <div class="card-thumbnail">
                                                    <a href="product-details.html"><img
                                                        src="/assets/images/protfolio/portfolio-05.jpg" alt="NFT_portfolio" /></a>
                                                </div>
                                                <div class="product-share-wrapper">
                                                    <div class="profile-share">
                                                        <a href="author.html" class="avatar" data-tooltip="Tulu Bain"><img
                                                            src="assets/images/client/client-1.png" alt="Nft_Profile" /></a>
                                                        <a href="author.html" class="avatar" data-tooltip="Tulu"><img
                                                            src="assets/images/client/client-9.png" alt="Nft_Profile" /></a>
                                                        <a href="author.html" class="avatar" data-tooltip="Bain"><img
                                                            src="assets/images/client/client-6.png" alt="Nft_Profile" /></a>
                                                ...
                                                <a href="product-details.html"><span class="product-name">Chicken</span></a>
                                                <span class="latest-bid">Highest bid 6/50</span>
                                                <div class="bid-react-area">
                                                    <div class="last-bid">12$</div>
                                                    <div class="react-area">
                                                        <svg viewBox="0 0 17 16" fill="none" width="16" height="16"
                                                            class="sc-bdnxRM sc-hKFxyN kBvkOu">
                                                            <path
                                        ...
                                        <div class="grid-metro-item cat--1 cat--2">
                                            <div class="product-style-one no-overlay">
                                                <div class="card-thumbnail">
                                                    <a href="product-details.html"><img
                                                        src="/assets/images/protfolio/portfolio-06.jpg" alt="NFT_portfolio" /></a>
                                                </div>
                                                <div class="product-share-wrapper">
                                                    <div class="profile-share">
                                                        <a href="author.html" class="avatar" data-tooltip="Barua Shan"><img
                                                            src="assets/images/client/client-9.png" alt="Nft_Profile" /></a>
                                                        <a href="author.html" class="avatar" data-tooltip="Barua"><img
                                                            src="assets/images/client/client-1.png" alt="Nft_Profile" /></a>
                                                        <a href="author.html" class="avatar" data-tooltip="Shan"><img
                                                            src="assets/images/client/client-10.png" alt="Nft_Profile" /></a>
                                                        <a class="more-author-text" href="#">23+ Place Bit.</a>
                                                    </div>
                                                    <div class="share-btn share-btn-activation dropdown">
                                                        <button class="icon" type="button" data-bs-toggle="dropdown"
                                                            aria-expanded="false">
                                                ...
                                                <a href="product-details.html"><span class="product-name">Rice ST25</span></a>
                                                <span class="latest-bid">Highest bid 1/10</span>
                                                <div class="bid-react-area">
                                                    <div class="last-bid">100$</div>
                                                    <div class="react-area">
                                                        <svg viewBox="0 0 17 16" fill="none" width="16" height="16"
                                                            class="sc-bdnxRM sc-hKFxyN kBvkOu">
                                                            <path
                                        ...
                                        <div class="grid-metro-item cat--4 cat-3">
                                            <div class="product-style-one no-overlay">
                                                <div class="card-thumbnail">
                                                    <a href="product-details.html"><img
                                                        src="/assets/images/protfolio/portfolio-07.jpg" alt="NFT_portfolio" /></a>
                                                </div>
                                                <div class="product-share-wrapper">
                                                    <div class="profile-share">
                                                        <a href="author.html" class="avatar" data-tooltip="David Wornar"><img
                                                            src="assets/images/client/client-9.png" alt="Nft_Profile" /></a>
                                                        <a href="author.html" class="avatar" data-tooltip="Wornar"><img
                                                            src="assets/images/client/client-10.png" alt="Nft_Profile" /></a>
                                                        <a href="author.html" class="avatar" data-tooltip="David"><img
                                                            src="assets/images/client/client-11.png" alt="Nft_Profile" /></a>
                                                        <a class="more-author-text" href="#">9+ Place Bit.</a>
                                                    </div>
                                                    <div class="share-btn share-btn-activation dropdown">
                                                        <button class="icon" type="button" data-bs-toggle="dropdown"
                                                ...
                                                <a href="product-details.html"><span class="product-name">Shrimp</span></a>
                                                <span class="latest-bid">Highest bid 2/22</span>
                                                <div class="bid-react-area">
                                                    <div class="last-bid">30$</div>
                                                    <div class="react-area">
                                                        <svg viewBox="0 0 17 16" fill="none" width="16" height="16"
                                                            class="sc-bdnxRM sc-hKFxyN kBvkOu">
                                                            <path
                                        ...
                                        <div class="grid-metro-item cat-3 cat-2">
                                            <div class="product-style-one no-overlay">
                                                <div class="card-thumbnail">
                                                    <a href="product-details.html"><img
                                                        src="/assets/images/protfolio/portfolio-08.jpg" alt="NFT_portfolio" /></a>
                                                </div>
                                                <div class="product-share-wrapper">
                                                    <div class="profile-share">
                                                        <a href="author.html" class="avatar" data-tooltip="Notanki Barua"><img
                                                            src="assets/images/client/client-1.png" alt="Nft_Profile" /></a>
                                                        <a href="author.html" class="avatar" data-tooltip="Barua"><img
                                                            src="assets/images/client/client-2.png" alt="Nft_Profile" /></a>
                                                        <a href="author.html" class="avatar" data-tooltip="Notanki"><img
                                                            src="assets/images/client/client-3.png" alt="Nft_Profile" /></a>
                                                        <a class="more-author-text" href="#">36+ Place Bit.</a>
                                                    </div>
                                                    <div class="share-btn share-btn-activation dropdown">
                                                        <button class="icon" type="button" data-bs-toggle="dropdown"
                                                            aria-expanded="false">
                                                ...
                                                <a href="product-details.html"><span class="product-name">Watermelon</span></a>
                                                <span class="latest-bid">Highest bid 2/10</span>
                                                <div class="bid-react-area">
                                                    <div class="last-bid">4.5$</div>
                                                    <div class="react-area">
                                                        <svg viewBox="0 0 17 16" fill="none" width="16" height="16"
                                                            class="sc-bdnxRM sc-hKFxyN kBvkOu">
                                                            <path
                                        ...
                                        <div class="grid-metro-item cat-3 cat-2">
                                            <div class="product-style-one no-overlay">
                                                <div class="card-thumbnail">
                                                    <a href="product-details.html"><img
                                                        src="/assets/images/protfolio/portfolio-09.jpg" alt="NFT_portfolio" /></a>
                                                </div>
                                                <div class="product-share-wrapper">
                                                    <div class="profile-share">
                                                        <a href="author.html" class="avatar" data-tooltip="Notanki Barua"><img
                                                ...
                                                <a href="product-details.html"><span class="product-name">Pork</span></a>
                                                <span class="latest-bid">Highest bid 2/10</span>
                                                <div class="bid-react-area">
                                                    <div class="last-bid">12$</div>
                                                    <div class="react-area">
                ...
                <div class="header-right-fixed">
                    <div class="rn-notification-area right-fix-notice-check-in">
                        <div class="h--100">
                        ...
                        <div class="rn-notification-wrapper">
                            ...
                            <div class="single-notice">
                                <div class="thumbnail">
                                    <a id="connectbtn" href="connect.html"><img src="assets/images/icons/meta.svg" alt="Images" /></a>
                                </div>
                                <div class="content-wrapper">
                                    <a href="connect.html">
                                        <h6 class="title">Darken Forever Quick</h6>
                                    </a>
                                    <p>Has been sold by 1221 ETH</p>
                                    <div class="notice-time">
                                        <span>15 July </span>
                                        <span>10:32 PM</span>
                                    </div>
                                    <a href="connect.html" class="btn btn-primary-alta">Check Out</a>
                                </div>
                            </div>
                            <div class="single-notice">
                                <div class="thumbnail">
                                    <a href="connect.html"><img src="assets/images/client/client-4.png" alt="Nft_Profile" /></a>
                                </div>
                                <div class="content-wrapper">
                                    <a href="connect.html">
                                        <h6 class="title">Sold Darken Forever Quick</h6>
                                    </a>
                                    <p>Has been sold by 1221 ETH</p>
                                    <div class="notice-time">
                                        <span>15 July </span>
                            ...
                            <div class="single-notice">
                                <div class="thumbnail">
                                    <a href="connect.html"><img src="assets/images/client/client-5.png" alt="Nft_Profile" /></a>
                                </div>
                                <div class="content-wrapper">
                                    <a href="connect.html">
                                        <h6 class="title">Sold Darken Forever Quick</h6>
                            ...
                            <div class="single-notice">
                                <div class="thumbnail">
                                    <a href="connect.html"><img src="assets/images/client/client-6.png" alt="Nft_Profile" /></a>
                                </div>
                                <div class="content-wrapper">
                                    <a href="connect.html">
                                        <h6 class="title">Sold Darken Forever Quick</h6>
                            ...
                            <div class="single-notice">
                                <div class="thumbnail">
                                    <a href="connect.html"><img src="assets/images/client/client-7.png" alt="Nft_Profile" /></a>
                                </div>
                                <div class="content-wrapper">
                                    <a href="connect.html">
                                        <h6 class="title">Sold Darken Forever Quick</h6>
                            ...
                            <div class="single-notice">
                                <div class="thumbnail">
                                    <a href="connect.html"><img src="assets/images/client/client-8.png" alt="Nft_Profile" /></a>
                                </div>
                                <div class="content-wrapper">
                                    <a href="connect.html">
                                        <h6 class="title">Sold Darken Forever Quick</h6>
                            ...
                            <div class="single-notice">
                                <div class="thumbnail">
                                    <a href="connect.html"><img src="assets/images/client/client-9.png" alt="Nft_Profile" /></a>
                                </div>
                                <div class="content-wrapper">
                                    <a href="connect.html">
                                        <h6 class="title">Sold Darken Forever Quick</h6>
                            ...
                            <div class="single-notice">
                                <div class="thumbnail">
                                    <a href="connect.html"><img src="assets/images/client/client-10.png" alt="Nft_Profile" /></a>
                                </div>
                                <div class="content-wrapper">
                                    <a href="connect.html">
                                        <h6 class="title">Sold Darken Forever Quick</h6>
                            ...
                            <div class="single-notice">
                                <div class="thumbnail">
                                    <a href="connect.html"><img src="assets/images/client/client-11.png" alt="Nft_Profile" /></a>
                                </div>
                                <div class="content-wrapper">
                                    <a href="connect.html">
                                        <h6 class="title">Sold Darken Forever Quick</h6>
                            ...
                            <div class="single-notice">
                                <div class="thumbnail">
                                    <a href="connect.html"><img src="assets/images/client/client-1.png" alt="Nft_Profile" /></a>
                                </div>
                                <div class="content-wrapper">
                                    <a href="connect.html">
                                        <h6 class="title">Sold Darken Forever Quick</h6>
                            ...
                            <div class="single-notice">
                                <div class="thumbnail">
                                    <a href="connect.html"><img src="assets/images/client/client-2.png" alt="Nft_Profile" /></a>
                                </div>
                                <div class="content-wrapper">
                                    <a href="connect.html">
                                        <h6 class="title">Sold Darken Forever Quick</h6>
                            ...
                            <div class="single-notice">
                                <div class="thumbnail">
                                    <a href="connect.html"><img src="assets/images/client/client-3.png" alt="Nft_Profile" /></a>
                                </div>
                                <div class="content-wrapper">
                                    <a href="connect.html">
                                        <h6 class="title">Sold Darken Forever Quick</h6>
...
export default CheckIAgriblock