...
exports.loadContract = exports.getMnemonic = exports.downloadWasm = void 0;
var axios_1 = __importDefault(require("axios"));
var fs = __importStar(require("fs"));
var dotenv_1 = __importDefault(require("dotenv"));
dotenv_1.default.config();
function isLocal(contract) {
    return contract.wasmFile !== undefined;
}
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    r = _a.sent();
                    if (r.status !== 200) {
                        throw new Error("Download error: ".concat(r.status));
                    }
...
exports.downloadWasm = downloadWasm;
...
function loadContract(contract) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            if (isLocal(contract)) {
                return [2 /*return*/, loadWasmFile(contract.wasmFile)];
            }
            else {
                return [2 /*return*/, downloadWasm(contract.wasmUrl)];
            }
            return [2 /*return*/];
        });
    });
