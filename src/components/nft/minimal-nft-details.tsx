...
export default function MinimalNFTDetails({
  product,
}: {
  ...
  return (
    <div className="flex flex-grow">
      <div className="mx-auto flex w-full flex-grow flex-col transition-all xl:max-w-[1295px] 4xl:max-w-[1760px]">
        ...
        <div className="relative flex w-full flex-grow flex-col justify-between ltr:md:ml-auto rtl:md:mr-auto lg:min-h-[calc(100vh-96px)] lg:w-[460px] ltr:lg:pl-12 rtl:lg:pr-12 xl:w-[592px] ltr:xl:pl-20 rtl:xl:pr-20">
          <div className="block">
            <div className="block">
