  ...
  return (
    <div className={cn(className)}>
      <Listbox value={selectedCoin} onChange={setSelectedCoin}>
        <Listbox.Button className="flex h-11 w-full items-center justify-between whitespace-nowrap border-gray-100 px-4 pl-3 text-sm text-gray-900 ltr:rounded-bl-lg ltr:rounded-tl-lg ltr:border-r rtl:border-l dark:border-gray-700 dark:bg-light-dark dark:text-white sm:h-13 sm:pl-4">
