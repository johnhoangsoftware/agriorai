        ...
        {coinListData.length > 0 ? (
          coinListData.map((item, index) => (
            <li
              ...
              className="mb-1 flex cursor-pointer items-center gap-3 px-6 py-1.5 outline-none hover:bg-gray-100 focus:bg-gray-200 dark:hover:bg-gray-700 dark:focus:bg-gray-600"
            >
