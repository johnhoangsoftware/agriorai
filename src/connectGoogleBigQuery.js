...
function connectGoogleBigQuery() {
    ...
    var bigquery = new bigquery_1.BigQuery({
        ...
        keyFilename: '../key.json', // (không bắt buộc nếu bạn chạy ứng dụng trên GCP)
    });
    // Định nghĩa các thông tin về bảng và dữ liệu cần thêm vào
    var tableId = 'agriblock-382802.usershop.detail';
    var rows = [
    ...
    function insertData() {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, bigquery.dataset('usershop').table('detail').insert(rows)];
                    case 1:
