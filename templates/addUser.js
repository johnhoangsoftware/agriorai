...
var connectGoogleBigQuery_1 = require("./connectGoogleBigQuery");
// Tạo một client BigQuery
function addUser(data) {
    // Thêm dữ liệu vào bảng
    var bigquery = (0, connectGoogleBigQuery_1.default)();
    function insertData(data) {
        return __awaiter(this, void 0, void 0, function () {
            var apiResponse;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, bigquery.dataset('usershop').table('detail').insert(data)];
                    case 1:
